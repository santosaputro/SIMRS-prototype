    ...
    <div class="dropdown mega-menu d-none d-md-block">
      ...
      <div
        ...
        style="
          ...
          top: 0px;
          left: 0px;
          transform: translate3d(216px, 57px, 0px);
        "
      >
        <div class="row m-0">
    ...
    <div class="dropdown">
      ...
      <div
        ...
        style="
          ...
          top: 0px;
          left: 0px;
          transform: translate3d(40px, 36px, 0px);
        "
      >
        ...
        <div class="ps__rail-y" style="top: 0px; right: 0px; height: 260px">
          <div
            class="ps__thumb-y"
            tabindex="0"
      ...
      <div class="user col align-self-end">
        ...
        <div
          ...
          style="
            ...
            top: 0px;
            left: 0px;
            transform: translate3d(51px, 36px, 0px);
          "
        >
